...
public class CustomBootSpeed1 extends CustomItem {

    public CustomBootSpeed1() {
        super("speed1", new ItemCreator(Material.DIAMOND_BOOTS).setUnbreakable(true).setName("§bBottes d'Astronaute").setLores("", "§7Ces bottes vous permettent", "§7d'obtenir §bspeed III").getItem());
    }
