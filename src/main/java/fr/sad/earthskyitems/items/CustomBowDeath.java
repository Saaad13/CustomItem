...
public class CustomBowDeath extends CustomItem {

    private final HashMap<UUID, Integer> map = Maps.newHashMap();

    public CustomBowDeath() {
        super("bow_unlimited", new ItemCreator(Material.BOW).setUnbreakable(true).setName("§6Arc Spatial").setLores("", "§7Cet arc reste dans votre", "§7inventaire même après votre mort.").getItem());
    }
